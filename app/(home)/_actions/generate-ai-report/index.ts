...
export const GenerateAiReport = async({month}: GenerateAiReportSchema) => {
    ...
    if(!hasPremiumPlan) throw new Error("You need a premium plan to generate AI reports")
    ...
    const content = `Gere um relatório com insights sobre minhas finanças, com dicas e orientações 
    de como melhorar minha vida financeira. As transações estão divididas por ponto e vírgula.
