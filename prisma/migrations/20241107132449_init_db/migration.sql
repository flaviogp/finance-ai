...
-- CreateEnum
CREATE TYPE "TransactionCatergory" AS ENUM ('HOUSING', 'TRANSPORTATION', 'FOOD', 'ENTERTAINMENT', 'HEALTH', 'UTILITY', 'SALARY', 'EDUCATION', 'OTHER');
...
CREATE TABLE "Transaction" (
    ...
    "category" "TransactionCatergory" NOT NULL,
